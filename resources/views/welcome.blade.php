                    ...
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">
                                <div class="avatar avatar-40 rounded icon pt-3"><i class="bi bi-house-door"></i></div>
                                <div class="col">Dashboard</div>
                                <div class="arrow pt-3"><i class="bi bi-arrow-right"></i></div>
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                                aria-expanded="false">
                                <div class="avatar avatar-40 rounded icon pt-3"><i class="bi bi-shop"></i></div>
                                <div class="col">Shop</div>
                                <div class="arrow pt-3"><i class="bi bi-plus plus"></i> <i class="bi bi-dash minus"></i>
                                </div>
                            </a>
        ...
        <div class="main-container container">
            ...
            <div class="row mb-4">
                <div class="col-12 col-md-6 mx-auto">
                    <h3 class="mb-1 text-center">Selamat Pagi;</h3>
                    <p class="text-opac mb-4 text-center">Semangat Pagi... Pagi Pagi pagi !!!!</p>
                </div>
            </div>
        </div>
